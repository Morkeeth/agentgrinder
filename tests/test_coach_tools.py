...
def _sitting(tmp_path, cwd=None):
    ...
    lines = [
        ...
        _rec("assistant", [{"type": "tool_use", "name": "Bash", "input": {"command": "pytest -q"}}],
             "2026-09-03T10:00:15Z", cwd),
        _rec("user", [{"type": "tool_result", "content": "3 passed in 0.2s"}], "2026-09-03T10:00:20Z", cwd),
        _rec("assistant", [{"type": "text", "text": "Suite passes."}], "2026-09-03T10:00:30Z", cwd),
