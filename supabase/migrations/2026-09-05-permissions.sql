...
grant execute on function grinder_profile_id(),grinder_is_member(uuid),grinder_owns_crew(uuid),grinder_can_read_run(uuid),grinder_can_read_practice(uuid) to anon,authenticated;
commit;
